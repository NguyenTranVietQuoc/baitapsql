...
SELECT COUNT(u.user_id) AS 'Số lượng like',
u.user_id, u.full_name FROM users AS u
...
VALUES
    ...
    ('Falafel Wrap', 8.49, 'falafel_wrap.jpg', 'Middle Eastern wrap with falafel, hummus, and veggies.',8),
...
VALUES
   ...
   SELECT COUNT(u.user_id) AS 'lượt order',
